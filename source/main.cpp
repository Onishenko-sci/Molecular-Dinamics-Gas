...
int main()
{
    ...
    molecular_dinamics gas(Argon, 100, 20, 20);
    ...
    // Частицы, распределённые этим методом, не могут находиться ближе друг к другу, чем их радиус взаимодействия.

    // Установка температуры модели
    gas.set_temperature(10.1);
